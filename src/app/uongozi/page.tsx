      ...
      <div className="container mx-auto px-4">
        ...
        {leaders.length === 0 ? (
          <Alert className="max-w-xl mx-auto">
            ...
            <AlertTitle>No Leadership Information Found</AlertTitle>
            <AlertDescription>
              Could not retrieve leadership data from the database. Please ensure you have created the 'leadership' collection in Firestore and added documents to it.
            </AlertDescription>
          </Alert>
        ) : (
