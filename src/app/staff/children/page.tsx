    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground font-body">
          This feature is under construction. Soon you will be able to manage check-ins and curriculum here.
        </p>
      </div>
      <Card>
        <CardHeader>
          <CardTitle>Coming Soon</CardTitle>
          <CardDescription>The secure check-in and curriculum management interface will be available here.</CardDescription>
        </CardHeader>
        <CardContent>
